				...
				<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}">
					...
					<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-1 me-lg-13">
							<a href="index.html">
								<img alt="Logo" src="{{asset('assets/media/logos/demo43.svg')}}" class="h-20px h-lg-30px theme-light-show" />

								<img alt="Logo" src="{{asset('assets/media/logos/demo43-dark.svg')}}" class="h-20px h-lg-30px theme-dark-show" />
							</a>
						</div>
						<!--end::Logo-->
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item" id="kt_header_user_menu_toggle">
									...
									<div class="d-flex align-items-center border border-dashed border-gray-300 rounded p-2" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<!--begin:Info-->
										<div class="me-4">
											<a href="pages/user-profile/projects.html" class="text-gray-900 text-hover-primary fs-6 fw-bold">Jacob Jones</a>
											<a href="pages/user-profile/overview.html" class="text-gray-500 text-hover-primary fs-7 fw-bold d-block">@jacobjs</a>
										</div>
										<!--end:Info-->
							...
							<div class="d-flex flex-stack flex-row-fluid">
								...
								<div class="d-flex align-items-center gap-3">
									...
									<div class="m-0">
										...
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_680f52a26416d">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_680f52a26416d" data-allow-clear="true">
															<option></option>
